...
import static com.hl.constant.UserConstant.USER_LOGIN_STATE;
...
import com.hl.model.enums.UserRoleEnum;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
     ...
     * 盐值，混淆密码
     */
    public static final String SALT = "lang";
    ...
    public User getLoginUserByRequest() {
        ...
        HttpServletRequest request = RequestContextHolder.getContext();
        if (request == null) {
